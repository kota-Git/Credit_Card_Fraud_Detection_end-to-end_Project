...
from Demo_project.utils.main_utils import load_numpy_array_data, read_yaml_file, load_object, save_object
from Demo_project.entity.config_entity import ModelTrainerConfig
from Demo_project.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetricArtifact
from Demo_project.entity.estimator import CreditCardModel  # Ensure that CreditCardModel is defined in estimator module
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            credit_card_model = CreditCardModel(preprocessing_object=preprocessing_obj,
