from Demo_project.entity.config_entity import ModelEvaluationConfig
from Demo_project.entity.artifact_entity import ModelTrainerArtifact, DataIngestionArtifact, ModelEvaluationArtifact
from sklearn.metrics import f1_score
from Demo_project.exception import Credit_card_Exception
from Demo_project.constants import TARGET_COLUMN
...
from Demo_project.entity.estimator import CreditCardModel
...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[CreditCardEstimator]:
        """
        ...
        try:
            ...
            usvisa_estimator = CreditCardEstimator(bucket_name=bucket_name,
